class ConfigParser(object):
    def __init__(self):
        ...
        self.config = {'p': 60275702009245096385686171515219896416297121499402250955537857683885541941187,
                       ...
                       'G': [29905514254078361236418469080477708234343499662916671209092838329800180225085,
                             2940593737975541915790390447892157254280677083040126061230851964063234001314],
                       'pb': [30466142855137288468788190552058120832437161821909553502398316083968243039754,
                              53312363470992020232197984648603141288071418796825192480967103513769615518274],
                       'k': 34550576952843389977837539438321907097625575044301827052096699664811526290255, 'w': 5,
                       'N': 500, 'floor': 2, 'ceil': 10}
        for i in data:
            if '#' in i or not i:
                continue
            line = i.split('=')
